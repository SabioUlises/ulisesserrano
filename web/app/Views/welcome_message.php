...
<html lang="en" class="no-js">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('recursos_landing/css/bootstrap.min.css'); ?>" type="text/css">
    <link rel="stylesheet" href="<?= base_url('recursos_landing/css/animate.css'); ?>" type="text/css">
    <link rel="stylesheet" href="<?= base_url('recursos_landing/css/animations.css'); ?>" type="text/css">
    <link rel="stylesheet" href="<?= base_url('recursos_landing/css/owl.carousel.css'); ?>" type="text/css">
    <link rel="stylesheet" href="<?= base_url('recursos_landing/css/magnific-popup.css'); ?>" type="text/css">
    <link rel="stylesheet" href="<?= base_url('recursos_landing/css/main.css'); ?>" type="text/css">

    <script src="<?= base_url('recursos_landing/js/modernizr.custom.js') ?>"></script>
  </head>
  ...
  <body>
    ...
    <div id="page" class="page">
      ...
      <header id="site_header" class="header mobile-menu-hide">
        <div class="header-content clearfix">
          <div class="my-photo">
            <img src="<?= base_url('recursos_landing/images/photo.jpg') ?>" alt="image">
          </div>

          <div class="site-title-block">
            <div class="site-title">Ulises Serrano</div>
          </div>
      ...
      <div class="mobile-header mobile-visible">
        <div class="mobile-logo-container">
          ...
          <div class="mobile-site-title"><a href="#">Ulises Serrano</a></div>
        </div>
                        ...
                        <div class="testimonials owl-carousel">
                          ...
                          <div class="testimonial-item">
                            ...
                            <div class="testimonial-credits">
                              ...
                              <div class="testimonial-picture">
                                <img src="<?= base_url('recursos_landing/images/testimonials/testimonial-2') ?>.jpg" alt="Gary Johnson"/>
                              </div>
                              <!-- /Picture -->
                          ...
                          <div class="testimonial-item">
                            ...
                            <div class="testimonial-credits">
                              <!-- Picture -->
                              <div class="testimonial-picture">
                                <img src="<?= base_url('recursos_landing/images/testimonials/testimonial-1') ?>.jpg" alt="Daniel Pringle"/>
                              </div>
                              <!-- /Picture -->
                              <!-- Testimonial author information -->
                              <div class="testimonial-author-info">
                          ...
                          <div class="testimonial-item">
                            ...
                            <div class="testimonial-credits">
                              <!-- Picture -->
                              <div class="testimonial-picture">
                                <img src="<?= base_url('recursos_landing/images/testimonials/testimonial-3') ?>.jpg" alt="Billy Adams"/>
                              </div>
                              <!-- /Picture -->
                              <!-- Testimonial author information -->
                              <div class="testimonial-author-info">
                        ...
                        <div class="clients owl-carousel">
                          <div class="client-block">
                            <a href="#" target="_blank" title="Logo">
                              <img src="<?= base_url('recursos_landing/images/clients/client-7.png') ?>" alt="Logo">
                            </a>
                          </div>
                          <div class="client-block">
                            <a href="#" target="_blank" title="Logo">
                              <img src="<?= base_url('recursos_landing/images/clients/client-6.png') ?>" alt="Logo">
                            </a>
                          </div>
                          <div class="client-block">
                            <a href="#" target="_blank" title="Logo">
                              <img src="<?= base_url('recursos_landing/images/clients/client-5.png') ?>" alt="Logo">
                            </a>
                          </div>
                          <div class="client-block">
                            <a href="#" target="_blank" title="Logo">
                              <img src="<?= base_url('recursos_landing/images/clients/client-4.png') ?>" alt="Logo">
                            </a>
                          </div>
                          <div class="client-block">
                            <a href="#" target="_blank" title="Logo">
                              <img src="<?= base_url('recursos_landing/images/clients/client-3.png') ?>" alt="Logo">
                            </a>
                          </div>
                          <div class="client-block">
                            <a href="#" target="_blank" title="Logo">
                              <img src="<?= base_url('recursos_landing/images/clients/client-2.png') ?>" alt="Logo">
                            </a>
                          </div>
                          <div class="client-block">
                            <a href="#" target="_blank" title="Logo">
                              <img src="<?= base_url('recursos_landing/images/clients/client-1.png') ?>" alt="Logo">
                            </a>
                          </div>
                        </div>
                        <!-- /Clients Carousel Block -->
                        ...
                        <div class="portfolio-grid three-columns">
                          ...
                          <figure class="item lbaudio" data-groups='["category_all", "category_soundcloud"]'>
                            <div class="portfolio-item-img">
                              <img src="<?= base_url('recursos_landing/images/portfolio/1.jpg') ?>" alt="SoundCloud Audio" title="" />
                          ...
                          <figure class="item standard" data-groups='["category_all", "category_media"]'>
                            <div class="portfolio-item-img">
                              <img src="<?= base_url('recursos_landing/images/portfolio/2.jpg') ?>" alt="Media Project 2" title="" />
                          ...
                          <figure class="item lbvideo" data-groups='["category_all", "category_vimeo-videos"]'>
                            <div class="portfolio-item-img">
                              <img src="<?= base_url('recursos_landing/images/portfolio/3.jpg') ?>" alt="Vimeo Video 1" title="" />
                          ...
                          <figure class="item standard" data-groups='["category_all", "category_media"]'>
                            <div class="portfolio-item-img">
                              <img src="<?= base_url('recursos_landing/images/portfolio/4.jpg') ?>" alt="Media Project 1" title="" />
                              <a href="portfolio-1.html" class="ajax-page-load"></a>
                            </div>
                          ...
                          <figure class="item lbimage" data-groups='["category_all", "category_mockups"]'>
                            <div class="portfolio-item-img">
                              <img src="<?= base_url('recursos_landing/images/portfolio/5.jpg') ?>" alt="Mockup Design 1" title="" />
                          ...
                          <figure class="item lbvideo" data-groups='["category_all", "category_youtube-videos"]'>
                            <div class="portfolio-item-img">
                              <img src="<?= base_url('recursos_landing/images/portfolio/6.jpg') ?>" alt="YouTube Video 1" title="" />
                          ...
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?= base_url('recursos_landing/images/blog/blog_post_6.jpg') ?>" class="size-blog-masonry-image-two-c" alt="Best Practices for Animated Progress Indicators" title="" />
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
                        ...
                        <div class="item post-2">
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?= base_url('recursos_landing/images/blog/blog_post_5.jpg') ?>" class="size-blog-masonry-image-two-c " alt="Designing the Perfect Feature Comparison Table" title="" />
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
                        ...
                        <div class="item post-3">
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?= base_url('recursos_landing/images/blog/blog_post_4.jpg') ?>" class="size-blog-masonry-image-two-c" alt="An Overview of E-Commerce Platforms" title=""/>
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
                        ...
                        <div class="item post-4">
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?= base_url('recursos_landing/images/blog/blog_post_3.jpg') ?>" class="size-blog-masonry-image-two-c" alt="Why I Switched to Sketch For UI Design" title="" />
                                <div class="mask"></div>
                                </a>
                            </div>
                            <div class="post-info">
                        ...
                        <div class="item post-5">
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?= base_url('recursos_landing/images/blog/blog_post_2.jpg') ?>" class="size-blog-masonry-image-two-c" alt="Creative and Innovative Navigation Designs" title="" />
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
                        ...
                        <div class="item post-6">
                          <div class="blog-card">
                            <div class="media-block">
                              ...
                              <a href="blog-post-1.html">
                                <img src="<?= base_url('recursos_landing/images/blog/blog_post_1.jpg') ?>" class="size-blog-masonry-image-two-c" alt="6 Easy Steps to Better Icon Design" title="" />
                                <div class="mask"></div>
                              </a>
                            </div>
                            <div class="post-info">
    ...
    <script src="<?= base_url('recursos_landing/js/jquery-2.1.3.min.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/bootstrap.min.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/pages-switcher.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/imagesloaded.pkgd.min.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/validator.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/jquery.shuffle.min.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/masonry.pkgd.min.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/owl.carousel.min.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/jquery.magnific-popup.min.js') ?>"></script>
    <script src='https://www.google.com/recaptcha/api.js'></script>
    <!--<script src="https://maps.googleapis.com/maps/api/js?key=YOUR-API-KEY"></script>-->
    <script src="https://maps.googleapis.com/maps/api/js"></script>
    <script src="<?= base_url('recursos_landing/js/jquery.googlemap.js') ?>"></script>
    <script src="<?= base_url('recursos_landing/js/main.js') ?>"></script>
  </body>
</html>
